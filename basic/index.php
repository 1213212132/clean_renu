...
<main id="index" class="main" role="main">
    <section id="main_visual">
        <div class="main_slide">
            ...
            <div class="itm">
                <strong>이사/싱가청소</strong>
                <span>오랫동안 누적된 공간의 묵은 때, 찌든 때, <br>
                누적된 먼지와 세균들을 이사하기전에 청소
            </span>
            ...
            <div class="itm">
                <strong>사무실청소</strong>
                <span>쾌적한 업무 환경을 만들고, 능률적인 업무를<br>
                수행하기 위해 반드시 필요한 청소
            </span>
                <p>쾌적한 업무 환경을 만들고, 능률적인 업무를 수행하기 위해 반드시 필요한 청소 작업 입니다.  <br>
    ...
    <section id="main_customer">
        <ul class="inner">
           ...
           <strong> 깔끄미청소소개</strong>
            ...
            <li><a href="<?=G5_THEME_URL;?>/doc/m031.php">
            <strong>이사상가청소</strong></a></li>
                    <li><a href="<?=G5_THEME_URL;?>/doc/m041.php">
                    <strong>사무실청소</strong></a></li>
            <li class="tel">
